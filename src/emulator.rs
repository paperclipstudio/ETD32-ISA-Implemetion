    ...
    fn test_st_16_bo_offset() {
        ...
        for i in 0..10 { 
            for address in 8..31 {
                ...
                cpu.write(5, (rand_value >> 8) as u8);
                cpu.write(6, (rand_value & 0xFF) as u8);
                cpu.write(7, 0);
                ...
                let value = (cpu.memory.read(address).unwrap() as u16) << 8 |
                    (cpu.memory.read(address + 1).unwrap()) as u16;
